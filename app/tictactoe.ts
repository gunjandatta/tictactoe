...
class TicTacToe {
    ...
    private canWin(board:string[][], posX:string = "", posY:string = "") {
        ...
        for(var i=0; i<this._winningPositions.length; i++) {
            ...
            if(isCpu) {
                ...
                // See if the player can win
                if(board[posX1][posY1] == "" && board[posX2][posY2] + board[posX3][posY3] == "XX") {
                    // Set the blocking position
                    pos = posX1 + posY1;
                }
                else if(board[posX2][posY2] == "" && board[posX1][posY1] + board[posX3][posY3] == "XX") {
                    // Set the blocking position
                    pos = posX2 + posY2;
                }
                else if(board[posX3][posY3] == "" && board[posX1][posY1] + board[posX2][posY2] == "XX") {
                    // Set the blocking position
                    pos = posX3 + posY3;
                }
    ...
    private selectBestPosition() {
        ...
        // See if we can win
        let pos = this.canWin(this._board);
        if(pos != "") {
            // Get the box
        ...
        for(var i=0; i<board.length; i++) {
            ...
            for(var j=0; j<board[i].length; j++) {
                ...
                let numbOfWins: number | string = this.canWin(board, i.toString(), j.toString());
